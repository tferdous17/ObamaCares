...
def pfp_wave(buzz, bg_m=1, fg=[1, 0.78, 0]):
    ...
    buzz_list=['../pictures/barack_obama_PNG27.png']
...
def model(buzz):
    ...
    #generates Transcript of the video using g4f gpt 4.0 Turbo model
...
>>> '''))
    ...
    runner(QueryList["script"],
        random.randint(1,3), # random bg music
        QueryList["voices"], # only want obama
        random.randint(1,4), # random gameplay
        1, # obama
        1, # subType 1
        random.randint(1, 5), # random font
